...
const STORAGE_KEY = "checkersmvp-v1";
...
function CheckersTournament({ onBack }) {
  ...
  function resetTournament() {
    const confirmReset = confirm(
      "Tem certeza que deseja apagar o torneio atual de damas?"
    );
  ...
  function exportTournament() {
    ...
    link.href = url;
    link.download = `${state.tournamentName || "damasmvp"}-torneio.json`;
    link.click();
  ...
  function importTournament(event) {
    ...
    reader.onload = () => {
      try {
        ...
        alert("Arquivo inválido. Selecione um arquivo JSON exportado pelo DamasMVP.");
      }
  ...
  return (
    <div className="app checkers-theme">
      ...
      {activeTab === "setup" && (
        <main className="grid two">
          ...
          <section className="panel wide">
            ...
            <p className="hint">
              Escolha o turno, a quantidade de mesas e o horário.
            </p>
      ...
      {activeTab === "round" && (
        <main className="panel">
          <div className="section-head">
            ...
            {doneRound && state.currentRound === state.totalRounds && (
              <div className="finished-badge">🏆 Torneio finalizado</div>
            )}
          </div>
            ...
            {ranking.map((player, index) => (
              <div key={player.id} className="rank-row">
                ...
                <small>
                  ...
                  <br />
                  FA {getOpponentStrength(player, state.players)} • Desempate{" "}
                  {player.tieBreakWins || 0}
                </small>
              </div>
            ))}
...
export default CheckersTournament;